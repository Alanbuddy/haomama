!function (e, t) {
    ...
    function l(e, t) {
        ...
        var c = t.list || [], r = t.type || "list", a = t.onClick || P,
            s = o('<ul class="' + ("list" === r ? "w-e-list" : "w-e-block") + '"></ul>');
        i.append(s), c.forEach(function (e) {
    ...
    function _(e) {
        var t = e.clipboardData || e.originalEvent && e.originalEvent.clipboardData, n = void 0, i = void 0;
    ...
    i.prototype = {
        constructor: i, forEach: function (e) {
            ...
            var c = A.parentElement, r = void 0;
            for (r = 0; r < i; r++)if (c === n[r])return o(c);
            return this.parentUntil(e, c)
        }, equal: function (e) {
    ...
    u.prototype = {
        constructor: u, show: function () {
            ...
            if (!(z.indexOf(t) >= 0)) {
                var n = t.editor, i = o("body"), A = n.$textContainerElem, c = this.opt,
                    r = o('<div class="w-e-panel-container"></div>'), a = c.width || 300;
                r.css("width", a + "px").css("margin-left", (0 - a) / 2 + "px");
                var s = o('<i class="w-e-icon-close w-e-panel-close"></i>');
                r.append(s), s.on("click", function () {
                    e.hide()
                });
                ...
                h.forEach(function (e, t) {
                    if (e) {
                        ...
                        l.append(A);
                        var c = o(i);
                        d.append(c), A._index = t, p.push(A), f.push(c), 0 === t ? (A._active = !0, A.addClass("w-e-active")) : c.hide(), A.on("click", function (e) {
                            A._active || (p.forEach(function (e) {
                    ...
                    e.hide()
                }), A.append(r), h.forEach(function (t, n) {
                    if (t) {
                        (t.events || []).forEach(function (t) {
                            var i = t.selector, o = t.type, A = t.fn || j;
                ...
                g.length && g.get(0).focus(), this.$container = r, this._hideOtherPanels(), z.push(t)
            }
        }, hide: function () {
            var e = this.menu, t = this.$container;
            t && t.remove(), z = z.filter(function (t) {
                return t !== e
            })
        }, _hideOtherPanels: function () {
            z.length && z.forEach(function (e) {
                var t = e.panel || {};
                t.hide && t.hide()
            })
        }
        ...
        constructor: h, onClick: function (e) {
            ...
            var n = this, i = r("input-link"), A = r("input-text"), c = r("btn-ok"), a = r("btn-del"),
                    ...
                    tabs: [{
                        ...
                        events: [{
                            selector: "#" + c, type: "click", fn: function () {
                                var e = o("#" + i), t = o("#" + A), c = e.val(), r = t.val();
                                return n._insertLink(r, c), !0
                            }
                        }, {
        ...
        constructor: v, _command: function (e) {
        ...
        constructor: C, onClick: function (e) {
            var t = this.editor, n = t.selection.getSelectionStartElem(), i = t.selection.getSelectionEndElem(),
                A = t.selection.isSelectionEmpty(), c = t.selection.getSelectionText(), r = void 0;
            return n.equal(i) ? A ? void(this._active ? this._createPanel(n.html()) : this._createPanel()) : (r = o("<code>" + c + "</code>"), t.cmd.do("insertElem", r), t.selection.createRangeByElem(r, !1), void t.selection.restoreSelection()) : void t.selection.restoreSelection()
        }, _createPanel: function (e) {
            var t = this;
            e = e || "";
            var n = e ? "edit" : "new", i = r("texxt"), A = r("btn"), c = new u(this, {
                width: 500,
                tabs: [{
                    title: "插入代码",
        ...
        constructor: I, onClick: function () {
            ...
            var e = this, t = r("btn"), n = r("row"), i = r("col"), A = new u(this, {
                width: 250,
                tabs: [{
                    title: "插入表格",
            ...
            var e = this, t = r("add-row"), n = r("add-col"), i = r("del-row"), o = r("del-col"), A = r("del-table");
            new u(this, {
                width: 320,
                tabs: [{
                    title: "编辑表格",
            ...
            if (n) {
                var i = n.getNodeName();
                if ("TD" === i || "TH" === i) {
                    var o = n.parent(), A = o.children(), c = A.length;
                    A.forEach(function (t, i) {
                        if (t === n[0])return e.td = {index: i, elem: t, length: c}, !1
                    });
                    var r = o.parent(), a = r.children(), s = a.length;
            ...
            if (e) {
                var t = e.tr, n = o(t.elem), i = e.td, A = i.length, c = document.createElement("tr"), r = "",
                    a = void 0;
                for (a = 0; a < A; a++)r += "<td>&nbsp;</td>";
                c.innerHTML = r, o(c).insertAfter(n)
            }
        }, _addCol: function () {
            var e = this._getLocationData();
            if (e) {
                ...
                o(t.elem).parent().children().forEach(function (e) {
                    var t = o(e), n = t.children(), A = n.get(i), c = A.getNodeName().toLowerCase();
                    o(document.createElement(c)).insertAfter(A)
                })
            }
        }, _delRow: function () {
            var e = this._getLocationData();
        ...
        constructor: Q, onClick: function () {
            ...
            var e = this, t = r("text-val"), n = r("btn"), i = new u(this, {
                width: 350,
                tabs: [{
                    title: "插入视频",
        ...
        constructor: D, onClick: function () {
            ...
            var e = this.editor, t = r("width-30"), n = r("width-50"), i = r("width-100"), o = r("del-btn"), A = [{
                title: "编辑图片",
            ...
            }], c = new u(this, {width: 300, tabs: A});
            c.show(), this.panel = c
        }, _createInsertPanel: function () {
            var e = this.editor, t = e.uploadImg, n = e.config, i = r("up-trigger"), A = r("up-file"),
                c = r("link-url"), a = r("link-btn"), s = [{
                    title: "上传图片",
    ...
    var $ = {};
    $.bold = s, $.head = d, $.link = h, $.italic = p, $.redo = f, $.strikeThrough = g, $.underline = m, $.undo = w, $.list = v, $.justify = b, $.foreColor = E, $.backColor = y, $.quote = B, $.code = C, $.emoticon = x, $.table = I, $.video = Q, $.image = D, M.prototype = {
        constructor: M,
        init: function () {
        ...
        _saveRangeRealTime: function () {
            ...
            function t(e) {
                ...
                if (t) {
                    ...
                    if ("CODE" === o && "PRE" === A && n.cmd.queryCommandSupported("insertHTML")) {
                        var c = n.selection.getRange().startOffset;
            ...
            t.on("paste", function (n) {
                if (!L.isIE()) {
                    ...
                    if (A) {
                        var c = A.getNodeName();
                        if ("CODE" !== c && "PRE" !== c && "TD" !== c && "TH" !== c)if ("DIV" === c || "<p><br></p>" === t.html()) {
                            if (!i)return;
                            try {
    ...
    T.prototype = {
        constructor: T, _alert: function (e, t) {
            ...
            var t = this;
            if (e && e.length) {
                var n = this.editor, i = n.config, o = i.uploadImgMaxSize, r = o / 1e3 / 1e3,
                    a = i.uploadImgMaxLength || 1e4, s = i.uploadImgServer, l = i.uploadImgShowBase64,
                    d = i.uploadFileName || "", u = i.uploadImgParams || {}, h = i.uploadImgHeaders || {},
                    p = i.uploadImgHooks || {}, f = i.uploadImgTimeout || 3e3, g = i.withCredentials;
                null == g && (g = !1);
                var m = [], w = [];
                if (c(e, function (e) {
                        var t = e.name, n = e.size;
                        if (t && n)return !1 === /\.(jpg|jpeg|png|bmp|gif)$/i.test(t) ? void w.push("【" + t + "】不是图片") : o < n ? void w.push("【" + t + "】大于 " + r + "M") : void m.push(e)
                    }), w.length)return void this._alert("图片验证未通过: \n" + w.join("\n"));
                if (m.length > a)return void this._alert("一次最多上传" + a + "张图片");
                var v = new FormData;
                if (c(m, function (e) {
                        var t = d || e.name;
                        v.append(t, e)
                    ...
                    var E = b[1] || "";
                    A(u, function (e, t) {
                        t = encodeURIComponent(t), s.indexOf("?") > 0 ? s += "&" : s += "?", s = s + e + "=" + t, v.append(e, t)
                    }), E && (s += "#" + E);
                    var y = new XMLHttpRequest;
                    return y.open("POST", s), y.timeout = f, y.ontimeout = function () {
                        p.timeout && "function" == typeof p.timeout && p.timeout(y, n), t._alert("上传图片超时")
                    }, y.upload && (y.upload.onprogress = function (e) {
                        var t = void 0, i = new N(n);
                        e.lengthComputable && (t = e.loaded / e.total, i.show(t))
                    }), y.onreadystatechange = function () {
                        var e = void 0;
                        if (4 === y.readyState) {
                            if (y.status < 200 || y.status >= 300)return p.error && "function" == typeof p.error && p.error(y, n), void t._alert("上传图片发生错误", "上传图片发生错误，服务器返回状态是 " + y.status);
                            if (e = y.responseText, "object" !== (void 0 === e ? "undefined" : J(e)))try {
                                e = JSON.parse(e)
                            } catch (i) {

                                alert(e);
                                console.log(e);
                                return p.fail && "function" == typeof p.fail && p.fail(y, n, e), void t._alert("上传图片失败", "上传图片返回结果错误，返回结果是: " + e)
                            }
                            if (p.customInsert || "0" == e.errno) {
                                if (p.customInsert && "function" == typeof p.customInsert) p.customInsert(t.insertLinkImg.bind(t), e, n); else {
                                    (e.data || []).forEach(function (e) {
                                        t.insertLinkImg(e)
                                    })
                                }
                                p.success && "function" == typeof p.success && p.success(y, n, e)
                            } else p.fail && "function" == typeof p.fail && p.fail(y, n, e), t._alert("上传图片失败", "上传图片返回结果错误，返回结果 errno=" + e.errno)
                        }
                    }, p.before && "function" == typeof p.before && p.before(y, n, m), A(h, function (e, t) {
                        y.setRequestHeader(e, t)
                    }), y.withCredentials = g, void y.send(v)
                }
                l && c(e, function (e) {
    ...
    H.prototype = {
        constructor: H, _initConfig: function () {
            ...
            var i = n.last();
            if (e) {
                var A = i.html().toLowerCase(), c = i.getNodeName();
                if ("<br>" !== A && "<br/>" !== A || "P" !== c)return t.append(o("<p><br></p>")), void this.initSelection()
            }
            this.selection.createRangeByElem(i, !1, !0), this.selection.restoreSelection()
        }, _bindEvent: function () {
            var e = 0, t = this.txt.html(), n = this.config, i = n.onchange;
