...
/* WEBPACK VAR INJECTION */(function($) {$(function() {
  ...
  $("#to_forget_password").click(function() {
    $("input").val("");
    return location.href = window.forget;
  });
  $("#signin_btn").attr("disabled", true);
  toggle_signin_tip = function(wrong) {
    if (wrong) {
      return $("#error_notice").css("visibility", "visible");
    } else {
      return $("#error_notice").css("visibility", "hidden");
    }
  };
  check_signin_input = function() {
    if ($("#mobile").val().trim() === "" || $("#password").val().trim() === "") {
      return $("#signin_btn").attr("disabled", true);
    } else {
      return $("#signin_btn").attr("disabled", false);
    }
  };
