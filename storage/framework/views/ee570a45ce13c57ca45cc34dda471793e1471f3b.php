    ...
    <ul>
        <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <li>
                ...
                <a href="<?php echo e(route('comments.show',['comment'=>$item->id])); ?>">
                    详细信息
                </a>
                <a href="<?php echo e(route('comments.edit',['comment'=>$item->id])); ?>">
                    编辑
                </a>
                <form action="<?php echo e(route('comments.destroy',['id'=>$item->id])); ?>" method="post" style="display: inline">
